...
//Níveis de PATH
//Quando em produção, descer dois níveis(../../../)
const NIVELPATH = "../";
// OUTROS PERIMETROS
...
var mapImageLayer = new ol.layer.Image({
      source: new ol.source.ImageStatic({
        url: NIVELPATH + 'wp-includes/img/background.png',        
        imageExtent: extent,
...
jQuery(document).ready(function() {
  ...
  enlargeThumb = function(code){
    ...
    imgUrl = "<img src='" + NIVELPATH + "wp-content/themes/gestaourbana-1.2/uploads/"+code+".png' alt='"+proposta.titulo+"' />";
    jQuery('#propostaTitulo').html(proposta.titulo);      
    jQuery('#propostaTexto').html(proposta.texto);
    jQuery('#propostaImagem').html('<img src="'+ NIVELPATH + 'wp-content/themes/gestaourbana-1.2/uploads/'+code+'.png" alt="'+code+'" />');
  ...
  var updateModal = function(layer) {
    if (layer.get('name') !== '21') {
      ...
      if(proposta != undefined){
        imgUrl = "<img src='" + NIVELPATH + "wp-content/themes/gestaourbana-1.2/uploads/"+layerName.split('_')[1]+".png' alt='"+proposta.titulo+"' />";
        jQuery('#propostaTitulo').html(proposta.titulo);      
        jQuery('#propostaImagem').html(imgUrl);
        jQuery('#propostaTexto').html(proposta.texto);      
      }
  ...
  var perimetroMaior = platMapAPI.createCustomVectorLayerFromKML(NIVELPATH + "wp-content/themes/gestaourbana-1.2/uploads/PerimetroACT.kml", lStyle);
  ...
  for (codigo in information){
    ...
    if(propsNumber < 33 && splitCode != "10D") {
      ...
      var thumb = '<img src="' + NIVELPATH + 'wp-content/themes/gestaourbana-1.2/uploads/'+splitCode+'_thumb.png" onclick="enlargeThumb(\''+splitCode+'\')" alt="'+codigo+'" width="150" />';
    ...
    if (feature && cLayer.get('name') !== '21' && cLayer.get('name') !== '_12A') {      
      ...
      if(proposta != undefined){
        if(isAIU){
          ...
          imgUrl = "<img src='" + NIVELPATH + "wp-content/themes/gestaourbana-1.2/uploads/"+layer.split('_')[1]+".png' alt='"+proposta.titulo+"' />";
        }
        jQuery('#propostaTitulo').html(proposta.titulo);      
        jQuery('#propostaImagem').html(imgUrl);
        jQuery('#propostaTexto').html(proposta.texto);      
